...
// import '../SignUpSettings/SignUpSettings.sass';
// import './UpdateSignUpSettings.sass';
// import { Link } from 'react-router-dom';
// import pic_placeholder from '../../img/profile-placeholder.jpg';
// import axios from 'axios';
// import { v4 as randomString } from 'uuid';

// const UpdateSignUpSettings = props => {
...
// 	const [inputsToggle, setInputsToggle] = useState({
// 		name: false,
// 		Number: false,
// 		zip: false,
// 		bio: false
...
// 							/>
// 							<i
// 								onClick={() => setInputsToggle(!inputsToggle.name)}
// 								className='fas fa-save'
// 							></i>
// 						</div>
// 					) : (
// 						<div className='enter-new-data'>
// 							<p className='name'>
// 								Kevin
// 								<i
// 									onClick={() => setInputsToggle({ name: !inputsToggle.name })}
...
// 							<i
// 								onClick={() =>
// 									setInputsToggle({ number: !inputsToggle.number })
// 								}
// 								className='fas fa-save'
// 							></i>
// 						</div>
...
// 							/>
// 							<i
// 								onClick={() => setInputsToggle({ zip: !inputsToggle.zip })}
// 								className='fas fa-save'
// 							></i>
// 						</div>
// 					) : (
...
// 							/>
// 							<i
// 								onClick={() => setInputsToggle({ bio: !inputsToggle.bio })}
// 								className='fas fa-save'
// 							></i>
// 						</div>
// 					) : (
...
// export default UpdateSignUpSettings;
